      ...
      <div>
        <div className="lg:pl-72">
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8" style={{
            ...
            {/* Separator */}
            <div className="h-6 w-px bg-white-200 lg:hidden" aria-hidden="true" />
              
            <div className="relative flex flex-1 lg:flex lg:gap-x-12 text-white "> {/* Modified line */}
             ...
             {navigation.map((item) => (
              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                <button type="button" className="-m-2.5 p-2.5 text-white-400 hover:text-gray-500">
                ...
                <Menu as="div" className="relative">
                  <Menu.Button className="-m-1.5 flex items-center p-1.5">
                    ...
                    <span className="hidden lg:flex lg:items-center">
                      ...
                      <ChevronDownIcon className="ml-2 h-5 w-5 text-white-400" aria-hidden="true" />
                    </span>
                  </Menu.Button>
                  <Transition
                    as={Fragment}
