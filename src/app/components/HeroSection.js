...
{
  /* #00D6BA #5F9AC7 #00BED6 #00D65F #00D65F #A5EDD6 #c8fded */
}

export default function HeroSection() {
  return (
    <div className="w-screen bg-gradient-radial from-[#c8fded]">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          ...
          <div className="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
            ...
            <img
              src="./heroImage.jpg"
              alt=""
              className="mx-auto w-[35rem] max-w-full drop-shadow-xl shadow-2xl rounded-lg"
            />
          </div>
        </div>
      </div>
